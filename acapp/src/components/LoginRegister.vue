<template>
  <div class="box container">
    <div class="pre-box">
      ...
      <div class="img-box">
        <img
          src="https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/501/waoku.jpg"
          alt=""
        />
      </div>
    </div>
  ...
  setup () {
    ...
    const mySwitch = () => {
      if (flag) {
        ...
        $("img").attr("src", "https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/501/wuwu.jpeg");
      }
      else {
        $(".pre-box").css("transform", "translateX(0%)");
        $(".pre-box").css("background-color", "#edd4dc");
        $("img").attr("src", "https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/501/waoku.jpg");
      }
      flag = !flag;
    }
    const login = () => {
