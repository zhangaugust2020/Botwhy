      ...
      <div class="col-7 chat-board">
        <div class="chat-board-content" ref="board_content">
          <div
            ...
            "
            v-for="msg in $store.state.pk.snake.history"
            :key="msg.id"
          >
            <img
              class="item-avatar"
              :src="
                msg.is_me
                  ...
                  : $store.state.pk.snake.opponent_photo
              "
              alt=""
            />
            <span
            ...
            <div class="both-sides row">
              ...
              <div class="col-5">
                ...
                <div class="info-rating">
                  rank {{ $store.state.pk.snake.self_rating }}
                </div>
              </div>
              <div class="col-4">
                <button
          ...
          <div class="card-body">
            <div class="both-sides row">
              ...
              <div class="col-5">
                ...
                <div class="info-rating">
                  rank {{ $store.state.pk.snake.opponent_rating }}
                </div>
              </div>
              <div class="col-4">
                <button
                  class="btn info-status"
                  :style="
                    $store.state.pk.snake.opponent_ready_status === '已准备'
                      ? 'color: #283B4C;'
                      : ''
                  "
                >
                  {{ $store.state.pk.snake.opponent_ready_status }}
                </button>
              </div>
            </div>
          </div>
