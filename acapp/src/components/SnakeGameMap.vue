...
export default {
  setup () {
    ...
    let canvas = ref(null);
    let pk_player = ref({});
    let direction_photo = ref("https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/501/none.png");
    direction_photo.value = computed(() => {
      switch (store.state.pk.snake.direction) {
        case 0:
          return "https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/501/up.png";
        case 1:
          return "https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/501/right.png";
        case 2:
          return "https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/501/down.png";
        case 3:
          return "https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/501/left.png";
        default:
          return "https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/501/none.png";
      }
    })
    const confirmInfo = () => {
