...
export default {
  ...
  setup () {
    ...
    const add_bot_event = () => {
      error_msg.value = '';
      $.ajax({
        url: "http://127.0.0.1:10300/api/user/bot/add",
        type: "post",
        contentType: "application/json",
    ...
    const update_bot_event = (bot) => {
      error_msg.value = '';
      $.ajax({
        url: "http://127.0.0.1:10300/api/user/bot/update",
        type: "post",
        contentType: "application/json",
    ...
    const remove_bot_event = (id) => {
      $.ajax({
        url: "http://127.0.0.1:10300/api/user/bot/remove",
        type: "post",
        data: {
          id,
        },
