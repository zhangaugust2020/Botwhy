    ...
    <div class="row">
      ...
      <div class="col-xs-8 col-sm-8 col-md-9">
        <div class="card" style="margin-top: 20px">
          ...
          <UserProfilePosts style="margin: 18px" :posts="info" :isme="false" :name="info.user.username" :otherId="userId" />
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  setup () {
    ...
    if (store.state.user.is_login) {
      $.ajax({
        url: "https://app459.acapp.acwing.com.cn/api/user/account/otherInfo",
        type: "get",
        data: {
          id: userId,
        },
